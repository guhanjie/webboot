/*
 * Copyright (c) copy from http://blog.csdn.net/yin_jw/article/details/32331453
 */
...
public class MemcachedUtils {
    ...
    private volatile static MemCachedClient cachedClient;
    ...
    private static class MemcachedLog {
        ...
        public static void writeLog(String content) {
            try {
                ...
                logWrite.write("[" + PID + "] " + "- [" + formatedNow + "]\r\n"
                        + content);
                logWrite.newLine();
                logWrite.flush();
            } catch (IOException e) {
