...
public class TPS {
	...
	private static TPS instance = null;
	...
	//可以创建新的TPS
	public  TPS(String name, int printIntervalSecond){
	 ...
	 * @return
	 */
	public static synchronized TPS getInstance(int printIntervalSecond){
		if(instance == null){		
				instance = new TPS("default",printIntervalSecond);
		}
		return instance;
	}
	...
	public static void main(String[] args ){
		...
		TPS tps = new TPS("main",2);		// 或者创建一个独用tps
